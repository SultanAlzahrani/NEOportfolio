<script lang="ts">
  const coolSites = [
    ...
    // },
    // {
    //   href: "https://ellenthekat.nekoweb.org",
    //   src: "https://ellenthekat.nekoweb.org/Images/oc%20headshot%20style.png",
    // },
    // {
    ...
    //   src: "/88x31/sites/reduc_anim.gif",
    // },
  ];
  ...
  const miscButtons = [
    ...
    {
      href: "https://ec.crypton.co.jp/pages/prod/virtualsinger/cv01_us",
      src: "/88x31/miku.gif",
    },
